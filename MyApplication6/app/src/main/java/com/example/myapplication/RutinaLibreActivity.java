...
public class RutinaLibreActivity extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rutina_libre);
    ...
    private void resetSteps(){
        pasos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(RutinaLibreActivity.this, "Mantenga presiionado para resetear los pasos", Toast.LENGTH_SHORT).show();
            }
        });
